...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none uppercase disabled:opacity-50 tracking-wide",
  {
    variants: {
      variant: {
        ...
        dengar:"bg-rose-500 text-primary-foreground hover:bg-rose-500/90 border-rose-600 border-b-4 active:border-b-0",
        dengarOutline:"bg-white text-rose-500 hover:bg-slate-100",
        ...
        sidebar:"bg-transparent text-slate-500 border-transparent border-transparent hover:bg-slate-100 transition-none",
